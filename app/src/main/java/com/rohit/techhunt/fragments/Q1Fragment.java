...
public class Q1Fragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = LayoutInflater.from(getContext()).inflate(R.layout.fragment_q1, container, false);
        ...
        test.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                reference.child("lv_1flag").addValueEventListener(new ValueEventListener() {
                    @Override
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        if (Objects.equals(dataSnapshot.getValue(), flagg.getText().toString())) {
                            ...
                            referencee.child("question1").setValue(flagg.getText().toString());
                        }else{

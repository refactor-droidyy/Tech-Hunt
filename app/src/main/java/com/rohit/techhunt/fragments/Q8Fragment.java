...
public class Q8Fragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = LayoutInflater.from(getContext()).inflate(R.layout.fragment_q8, container, false);
        ...
        test.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                reference.child("lv_8flag").addValueEventListener(new ValueEventListener() {
                    @Override
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        if (Objects.equals(dataSnapshot.getValue(), flagg.getText().toString())) {
                            ...
                            referencee.child("question8").setValue(flagg.getText().toString());
                        }else{
        ...
        ref.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                for (DataSnapshot mdataSnapshot : dataSnapshot.getChildren()) {
                    ...
                    assert user != null;
                    String level1 = user.getQuestion8();
                    if(level1.isEmpty()){
